    ...
    <div class="container mt-5">
        <div class="row mt-5 justify-content-md-center">
            ...
            <div class="col-12 col-sm-8 mt-3">
                <ul class="list-group">
                    <li class="list-group-item">Data de nascimento: <strong>{{$cliente->dt_nasc_cliente->format('d/m/Y')}}</strong></li>
            ...
            <div class="col-12 col-sm-6 mt-5 border-top text-muted pt-2">
                Cliente cadastrado em {{$cliente->created_at->format('d/m/Y H:i')}}
            </div>
